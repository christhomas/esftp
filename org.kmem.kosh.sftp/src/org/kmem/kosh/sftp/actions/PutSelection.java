...
package org.kmem.kosh.sftp.actions;
...
public class PutSelection extends Selection implements IWorkbenchWindowActionDelegate{
	public PutSelection(){ super(); }
	/**
	...
	public void run(IAction action) {	
		...
		if (m_selection != null && !m_selection.isEmpty()){
			if(buildList(TransferDetails.PUT) == false){
